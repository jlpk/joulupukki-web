            ...
            compress: {
                files: [{
                    '<%= project.build %>/js/adagios.min.js' : [
                        ...
                        '<%= project.app %>/components/live/get_latest_builds.js',
                        '<%= project.app %>/components/live/get_latest_projects.js',
                ...
                files: [
                    {
                        ...
                        '<%= project.build %>/components/live/get_latest_builds.js': '<%= project.app %>/components/live/get_latest_builds.js',
                        '<%= project.build %>/components/live/get_latest_projects.js': '<%= project.app %>/components/live/get_latest_projects.js',
                    ...
                    },
                    {
                        '<%= project.build %>/js/adagios.min.js' : [
                            ...
                            '<%= project.build %>/components/live/get_latest_builds.js',
                            '<%= project.build %>/components/live/get_latest_projects.js',
