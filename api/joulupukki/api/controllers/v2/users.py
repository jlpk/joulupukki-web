...
class UserController(rest.RestController):
    ...
    # curl -X POST -H "Content-Type: application/json" -i  -d '{"username": "titilambert", "email": "titilambert@localhost.local", "password": "titilambert", "name": "Thibault Cohen"}' http://127.0.0.1:8081/v2/titilambert
    ...
    # curl -X DELETE -H "Content-Type: application/json" -i  -d '{"username": "titilambert", "password": "titilambert"}' http://127.0.0.1:8081/v2/titilambert
    @wsme_pecan.wsexpose(wtypes.text, body=APIUser, status_code=201)
